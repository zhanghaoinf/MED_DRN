...
%------------
% Feature Folder
BgFile = [ dataRoot, Feature, '_COLLECTION_ENC_V5/Event_BG_', Pooling,'.mat' ];
PosFile= [ dataRoot, Feature, '_COLLECTION_ENC_V5/',DetectorType,'/E0', EventID, '_',Pooling,'.mat' ];

% Out Folder
OutFolder = [dataRoot, 'LinSVM_V5/',Feature, '/', DetectorType,'/'];
dirmake(OutFolder);
%--------------
TempBg = load(BgFile);
