...
Feature = 'DRN50_L5A';
BSFeatFolder = [ dataRoot, Feature, '_VLAD_ENC_V5/MED14_Test/'];
ModelFolder  = [ dataRoot, 'hz_LinFastSVM_V5/',Feature,'/',DetectorType,'/']
PredFolder   = [ dataRoot, 'hz_LinFastPred_V5/',Feature,'/',DetectorType,'/'];
dirmake(PredFolder);
%------------------
...
for VidCnt = StVid : EdVid
	...
	fprintf('|Predict|%d|%d-%d-%d|%s\n',VidNum, EdVid, VidCnt, StVid,Vid);
