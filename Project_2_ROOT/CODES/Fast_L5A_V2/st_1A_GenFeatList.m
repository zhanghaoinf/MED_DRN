...
posStaFolder  = [ dataRoot, 'FastSTA/E021-E040_100Ex/', feat, '/' ];
posFeatFolder = [ dataRoot, 'FastSP/E021-E040_100Ex/', feat, '/' ];
for vidCnt = 1: numPos
...
bgStaFolder = [ dataRoot, 'FastSTA/Event_BG/', feat, '/' ]; 
bgFeatFolder = [ dataRoot, 'FastSP/Event_BG/', feat, '/' ]; 
for vidCnt = 1: numBg
