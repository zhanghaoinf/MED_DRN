...
Feature = 'DRN50_pool5';
BSFeatFolder = [ dataRoot, Feature, '_VLAD_ENC/MED14_Test/'];
ModelFolder  = [ dataRoot, 'hz_LinFastSVM/',Feature,'/',DetectorType,'/']
PredFolder   = [ dataRoot, 'hz_LinFastPred/',Feature,'/',DetectorType,'/'];
dirmake(PredFolder);
%------------------
