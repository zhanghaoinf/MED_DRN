...
%------------
% Feature Folder
BgFile = [ dataRoot, Feature, '_COLLECTION_ENC_V3/Event_BG_', Pooling,'.mat' ];
PosFile= [ dataRoot, Feature, '_COLLECTION_ENC_V3/',DetectorType,'/E0', EventID, '_',Pooling,'.mat' ];

% Out Folder
OutFolder = [dataRoot, 'LinSVM_V3/',Feature, '/', DetectorType,'/'];
dirmake(OutFolder);
%--------------
TempBg = load(BgFile);
