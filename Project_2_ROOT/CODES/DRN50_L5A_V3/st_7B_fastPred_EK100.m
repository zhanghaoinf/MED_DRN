...
Feature = 'DRN50_L5A';
BSFeatFolder = [ dataRoot, Feature, '_VLAD_ENC_V3/MED14_Test/'];
ModelFolder  = [ dataRoot, 'hz_LinFastSVM_V3/',Feature,'/',DetectorType,'/']
PredFolder   = [ dataRoot, 'hz_LinFastPred_V3/',Feature,'/',DetectorType,'/'];
dirmake(PredFolder);
%------------------
