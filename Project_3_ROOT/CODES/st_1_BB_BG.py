...
InputFolder  = os.path.join(currentData, 'BB_IMAGE',DataSet)
FileList     = os.path.join(tv_root,'STRUCTURE' ,DataSet + '.txt')
OutputFolder_5A= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L5A/')
OutputFolder_5B= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L5B/')
OutputFolder_5C= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L5C/')
OutputFolder_4A= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L4A/')
OutputFolder_4B= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L4B/')
OutputFolder_4C= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L4C/')
OutputFolder_4D= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L4D/')
OutputFolder_4E= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L4E/')
OutputFolder_4F= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L4F/')
OutputFolder_3A= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L3A/')
OutputFolder_3B= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L3B/')
OutputFolder_3C= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L3C/')
OutputFolder_3D= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L3D/')
OutputFolder_2A= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L2A/')
OutputFolder_2B= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L2B/')
OutputFolder_2C= os.path.join( currentData,'RegionFeatures/' ,DataSet ,'DRN50_L2C/')
